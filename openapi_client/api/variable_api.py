    ...
    def __init__(self, api_client=None):
        ...
        def __create_variable(
            ...
            **kwargs
            ...
            >>> thread = api.create_variable(variable, async_req=True)
            >>> result = thread.get()
        ...
        self.delete_variable = Endpoint(
            settings={
                ...
                'endpoint_path': '/variables/{variable_id}',
        ...
        def __get_variable(
            ...
            **kwargs
            ...
            >>> thread = api.get_variable(variable_id, async_req=True)
            >>> result = thread.get()
        ...
        def __lookup_variable(
            ...
            **kwargs
            ...
            The response contains all fields, including data.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.lookup_variable(variable_key, async_req=True)
            >>> result = thread.get()
        ...
        self.lookup_variable = Endpoint(
            settings={
                'response_type': (Variable,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/variables/lookup',
                'operation_id': 'lookup_variable',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__lookup_variable
        )

        def __update_variable(
            self,
            variable_id,
            variable,
            **kwargs
            ...
            >>> thread = api.update_variable(variable_id, variable, async_req=True)
            >>> result = thread.get()
