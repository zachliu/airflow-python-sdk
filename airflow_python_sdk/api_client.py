...
from airflow_python_sdk import rest
from airflow_python_sdk.configuration import Configuration
from airflow_python_sdk.exceptions import ApiTypeError, ApiValueError, ApiException
from airflow_python_sdk.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/0.18.13/python'
